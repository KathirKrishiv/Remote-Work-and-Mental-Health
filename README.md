...
- Identify trends in productivity and well-being

- Understand key factors influencing employee performance

- Evaluate the relationship between mental health and productivity
...
2.  Identification of patterns between remote work and employee outcomes

3.  Interactive visualizations for better understanding

4.  Insights into mental health and productivity trends
...
Type: Employee survey / Behavioral dataset
...
- Data inspection using Python (head, info, describe, null values)

- Understanding distributions and initial patterns

**Stage 2: Data Cleaning & Preprocessing**

- Handling missing values

- Structuring and preparing data for analysis

**Stage 3: Dashboard Creation**

- Built interactive dashboards using Power BI

- Used charts, KPIs, and filters for insights

**Stage 4: Insights & Presentation**
...
- Mental health declines over time for some employees

- Productivity is directly influenced by employee well-being

- Work environment significantly affects performance
...
- Mental Health Impact: Increased stress and burnout in remote settings

- Strong Correlation: Better mental health leads to higher productivity

- Work Environment: Proper setup improves outcomes
...
- Adopt Hybrid Work Model: Balance remote and office work

- Improve Communication: Regular team interactions and check-ins

- Support Home Setup: Provide resources for better work environments
...
- Automate analysis using scripts and dashboards

- Enhance visualizations with advanced interactive dashboards
...
- Short-Term Gain: Remote work boosts productivity initially

- Hidden Challenge: Mental health declines over time

- Core Insight: Productivity depends on well-being

- Key Drivers: Work environment and communication

- Outcome: Balanced strategies are required for sustainable performance
...
Raw Dataset: [Remote Work and Mental Health Raw Dataset](https://drive.google.com/file/d/1co3qIEe2cx-PozoEbe0K7mwfdC6irZd6/view?usp=sharing)

Cleaned Dataset: [Remote Work and Mental Health Cleaned Dataset](https://drive.google.com/file/d/1yA7PzBZhCDSPj0ES6qyMl0pjQq841vOw/view?usp=sharing)

Google Colab: [Google Colab Link](https://colab.research.google.com/drive/1BsQfJssoa8to-0i4jbFP0rrRsfwmg92J%23scrollTo=VT6h4gg3lj-f)
